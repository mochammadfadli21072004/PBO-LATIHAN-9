...
public class AplikasiJumlhHari extends javax.swing.JFrame {

    /**
     * Creates new form AplikasiJumlhHari
     */
    public AplikasiJumlhHari() {
        initComponents();
    }
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        // TODO add your handling code here:
        try {
            File currentDirectory = new File(AplikasiJumlhHari.class.getProtectionDomain().getCodeSource().getLocation().toURI()).getParentFile();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AplikasiJumlhHari.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AplikasiJumlhHari().setVisible(true);
            }
        });
    }
